...
<head>
    ...
    <title>Đăng nhập tài khoản - K2 GEAR</title>
    <link rel="stylesheet" href="main.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        /* CSS FORM ĐĂNG NHẬP */
        .auth-page { background-color: #f4f6f8; padding: 60px 15px; min-height: 60vh;}
        .auth-container { max-width: 500px; margin: 0 auto; background: #fff; padding: 40px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); }
        ...
        .auth-subtitle a { color: #3b66cc; text-decoration: none; font-weight: bold;}
        ...
        .auth-form-control:focus { border-color: #3b66cc; box-shadow: 0 0 5px rgba(59,102,204,0.2); }
        
        .auth-forgot { display: block; font-size: 13px; color: #666; margin-bottom: 20px; }
        .auth-forgot a { color: #3b66cc; text-decoration: none; cursor: pointer;}
        .auth-forgot a:hover { text-decoration: underline; }
        
        .auth-btn { width: 100%; padding: 14px; background: #f2c94c; color: #333; border: none; border-radius: 4px; font-size: 16px; font-weight: bold; cursor: pointer; text-transform: uppercase; transition: 0.3s;}
        ...
        .btn-social { flex: 1; padding: 12px; border: none; border-radius: 4px; color: white; font-weight: bold; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 10px; font-size: 14px;}
        ...
        .error-box { background-color: #fde8e8; color: #ce0707; padding: 12px; border-radius: 4px; text-align: center; font-size: 14px; font-weight: bold; margin-bottom: 20px; border: 1px solid #f9caca; }
        .success-box { background-color: #e6f4ea; color: #0f8b4d; padding: 12px; border-radius: 4px; text-align: center; font-size: 14px; font-weight: bold; margin-bottom: 20px; border: 1px solid #cce8d6; }
    </style>
</head>
<body>
    ...
    <main class="auth-page">
        <div class="auth-container">
            ...
            if(isset($_SESSION['error'])) { 
                echo '<div class="error-box"><i class="fas fa-exclamation-triangle"></i> ' . $_SESSION['error'] . '</div>'; 
                unset($_SESSION['error']); 
            } 
            if(isset($_SESSION['success'])) { 
                echo '<div class="success-box"><i class="fas fa-check-circle"></i> ' . $_SESSION['success'] . '</div>'; 
            ...
            <div id="login-block">
                ...
                <p class="auth-subtitle">Bạn chưa có tài khoản ? <a href="register.php">Đăng ký tại đây</a></p>

                <form action="process_login.php" method="POST" autocomplete="off">
                    <div class="auth-form-group">
                        <label>Email <span>*</span></label>
                        <input type="email" name="email" class="auth-form-control" placeholder="Email" required autocomplete="off">
                    </div>

                    <div class="auth-form-group">
                        <label>Mật khẩu <span>*</span></label>
                        <input type="password" name="password" class="auth-form-control" placeholder="Mật khẩu" required autocomplete="new-password">
                    </div>

                    <div class="auth-forgot">
                        Quên mật khẩu? Nhấn vào <a id="showForgotBtn">đây</a>
                    </div>
            ...
            <div id="forgot-block" style="display: none;">
                <h1 class="auth-title">QUÊN MẬT KHẨU</h1>
                <p class="auth-subtitle" style="margin-bottom: 20px;">Vui lòng nhập địa chỉ email của bạn. Hệ thống sẽ gửi một liên kết để đặt lại mật khẩu.</p>

                <form action="process_forgot.php" method="POST" autocomplete="off">
                    <div class="auth-form-group">
                        <label>Email khôi phục <span>*</span></label>
                        <input type="email" name="reset_email" class="auth-form-control" placeholder="Nhập email của bạn..." required autocomplete="off">
                    </div>

                    <button type="submit" class="auth-btn" style="background: #3b66cc; color: white;">Gửi yêu cầu</button>
                </form>

                <div class="auth-forgot" style="text-align: center; margin-top: 25px;">
                    <a id="showLoginBtn"><i class="fas fa-arrow-left"></i> Quay lại Đăng nhập</a>
                </div>
            </div>
    ...
    <script>
        // Code cho Menu thả xuống góc phải
        ...
        // Code làm hiệu ứng ẩn/hiện chuyển đổi giữa Form Login và Form Quên MK
